	...
	Muse.Plugins.Lightbox = {
		...
		_initializeMarkup: function (b) {
			...
			if (0 == g.length) {
				...
				g.removeAttr("id");
				var q = d("<div/>").addClass("overlayWedge").insertBefore(Muse.Utils.includeMEditableTags(j)[0]);
				...
				if (b._fstpPositionSlides ||
					b._csspResizeFullScreenImages) o = function (a, d) {
		...
		if (-1 != a) {
			...
			for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
				...
				if ("generator" == d.getAttribute("name")) {
					"2017.0.2.363" != d.getAttribute("content") && Muse.assets.outOfDate.push("musewpslideshow.js");
					break
				}
			}
		}
